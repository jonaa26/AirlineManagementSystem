 ...
 * @author user
 */
public class viaBank extends javax.swing.JFrame {

    /**
     * Creates new form viaBank
     */
    public viaBank() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Your payment is done (viaBank)!");
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viaBank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
